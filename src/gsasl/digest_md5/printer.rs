use ::libc;
use libc::size_t;
use crate::gsasl::digest_md5::parser::{digest_md5_challenge, DIGEST_MD5_CIPHER_3DES, DIGEST_MD5_CIPHER_AES_CBC, DIGEST_MD5_CIPHER_DES, DIGEST_MD5_CIPHER_RC4, DIGEST_MD5_CIPHER_RC4_40, DIGEST_MD5_CIPHER_RC4_56, digest_md5_finish, digest_md5_response};
use crate::gsasl::digest_md5::qop::{DIGEST_MD5_QOP_AUTH, DIGEST_MD5_QOP_AUTH_CONF, DIGEST_MD5_QOP_AUTH_INT};
use crate::gsasl::digest_md5::validate::{digest_md5_validate_challenge, digest_md5_validate_finish, digest_md5_validate_response};
...
/* Get token types. */
#[no_mangle]
pub unsafe fn digest_md5_print_challenge(mut c: *mut digest_md5_challenge) -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe fn digest_md5_print_response(mut r: *mut digest_md5_response)
 -> *mut libc::c_char {
    let mut out: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub unsafe fn digest_md5_print_finish(mut finish: *mut digest_md5_finish)
 -> *mut libc::c_char {
    let mut out: *mut libc::c_char = 0 as *mut libc::c_char;
    /* Below we assume the mandatory fields are present, verify that
     first to avoid crashes. */

                                ...
                                client:
                                    {
                                        let mut init =
                                            Gsasl_mechanism_functions{init:
                                                                          ...
                                                                          None,
                                                                      start:
                                                                          Some(_gsasl_digest_md5_client_start
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      step:
                                                                          Some(_gsasl_digest_md5_client_step
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      finish:
                                                                          Some(_gsasl_digest_md5_client_finish
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           ()),
                                                                      encode:
                                                                          Some(_gsasl_digest_md5_client_encode
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      decode:
                                                                          Some(_gsasl_digest_md5_client_decode
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                ...
                                server:
                                    {
                                        let mut init =
                                            Gsasl_mechanism_functions{init:
                                                                          ...
                                                                          None,
                                                                      start:
                                                                          Some(_gsasl_digest_md5_server_start
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      step:
                                                                          Some(_gsasl_digest_md5_server_step
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      finish:
                                                                          Some(_gsasl_digest_md5_server_finish
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           ()),
                                                                      encode:
                                                                          Some(_gsasl_digest_md5_server_encode
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      decode:
                                                                          Some(_gsasl_digest_md5_server_decode
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:

...
pub type gc_secure_check_t
    =
    Option<unsafe extern "C" fn(_: *const libc::c_void) -> libc::c_int>;
pub type gc_realloc_t
    =
    Option<unsafe extern "C" fn(_: *mut libc::c_void, _: size_t)
               -> *mut libc::c_void>;
pub type gc_free_t = Option<unsafe extern "C" fn(_: *mut libc::c_void) -> ()>;
...
/* Ciphers. */
#[no_mangle]
pub unsafe extern "C" fn gc_init() -> Gc_rc { return GC_OK; }
#[no_mangle]
pub unsafe extern "C" fn gc_done() { }
...
unsafe extern "C" fn randomize(mut buffer: *mut libc::c_void,
...
/* Randomness. */
#[no_mangle]
pub unsafe extern "C" fn gc_nonce(mut data: *mut libc::c_char,
                                  mut datalen: size_t) -> Gc_rc {
    return randomize(data as *mut libc::c_void, datalen,
                     0 as libc::c_int as libc::c_uint) as Gc_rc;
}
#[no_mangle]
pub unsafe extern "C" fn gc_pseudo_random(mut data: *mut libc::c_char,
                                          mut datalen: size_t) -> Gc_rc {
    return randomize(data as *mut libc::c_void, datalen,
                     0 as libc::c_int as libc::c_uint) as Gc_rc;
}
#[no_mangle]
pub unsafe extern "C" fn gc_random(mut data: *mut libc::c_char,
                                   mut datalen: size_t) -> Gc_rc {
    return randomize(data as *mut libc::c_void, datalen,
...
/* Ciphers. */
#[no_mangle]
pub unsafe extern "C" fn gc_cipher_open(mut alg: Gc_cipher,
...
#[no_mangle]
pub unsafe extern "C" fn gc_cipher_close(mut handle: gc_cipher_handle)
 -> Gc_rc {
    let mut ctx: *mut _gc_cipher_ctx = handle as *mut _gc_cipher_ctx;
...
/* Hashes. */
#[no_mangle]
pub unsafe extern "C" fn gc_hash_open(mut hash: Gc_hash,
...
#[no_mangle]
pub unsafe extern "C" fn gc_hash_clone(mut handle: gc_hash_handle,
                                       mut outhandle: *mut gc_hash_handle)
 -> Gc_rc {
...
#[no_mangle]
pub unsafe extern "C" fn gc_hash_digest_length(mut hash: Gc_hash) -> size_t {
...
#[no_mangle]
pub unsafe extern "C" fn gc_hash_write(mut handle: gc_hash_handle,
                                       mut len: size_t,
...
#[no_mangle]
pub unsafe extern "C" fn gc_hash_read(mut handle: gc_hash_handle)
 -> *const libc::c_char {
    let mut ctx: *mut _gc_hash_ctx = handle as *mut _gc_hash_ctx;
...
#[no_mangle]
pub unsafe extern "C" fn gc_hash_close(mut handle: gc_hash_handle) {
    let mut ctx: *mut _gc_hash_ctx = handle as *mut _gc_hash_ctx;
    rpl_free(ctx as *mut libc::c_void);
}
...
#[no_mangle]
pub unsafe extern "C" fn gc_hash_buffer(mut hash: Gc_hash,
...
#[no_mangle]
pub unsafe extern "C" fn gc_md5(mut in_0: *const libc::c_void,
                                mut inlen: size_t,
...
#[no_mangle]
pub unsafe extern "C" fn gc_sha1(mut in_0: *const libc::c_void,
                                 mut inlen: size_t,
                                 mut resbuf: *mut libc::c_void) -> Gc_rc {
...
#[no_mangle]
pub unsafe extern "C" fn gc_sha256(mut in_0: *const libc::c_void,
                                   mut inlen: size_t,
                                   mut resbuf: *mut libc::c_void) -> Gc_rc {
...
#[no_mangle]
pub unsafe extern "C" fn gc_hmac_md5(mut key: *const libc::c_void,
                                     mut keylen: size_t,
                                     mut in_0: *const libc::c_void,
                                     mut inlen: size_t,
...
#[no_mangle]
pub unsafe extern "C" fn gc_hmac_sha1(mut key: *const libc::c_void,
                                      mut keylen: size_t,
                                      mut in_0: *const libc::c_void,
                                      mut inlen: size_t,
                                      mut resbuf: *mut libc::c_char)
...
#[no_mangle]
pub unsafe extern "C" fn gc_hmac_sha256(mut key: *const libc::c_void,
                                        mut keylen: size_t,
                                        mut in_0: *const libc::c_void,
                                        mut inlen: size_t,
                                        mut resbuf: *mut libc::c_char)

...
unsafe fn scram_start(mut _sctx: *mut Session,
...
pub unsafe fn _gsasl_scram_sha1_client_start(sctx: &mut Session,
...
pub unsafe fn _gsasl_scram_sha1_plus_client_start(sctx: &mut Session,
                                                  mech_data: &mut Option<NonNull<()>>
) -> libc::c_int
{
    let mut ptr = mech_data
...
pub unsafe fn _gsasl_scram_sha256_client_start(sctx: &mut Session,
                                               mech_data: &mut Option<NonNull<()>>,
) -> libc::c_int
{
    let mut ptr = mech_data
...
pub unsafe fn _gsasl_scram_sha256_plus_client_start(mut sctx: &mut Session,

...
pub unsafe extern "C" fn _gsasl_plain_client_step(mut sctx:
 ...
 -> libc::c_int {
    ...
    let mut authzidlen: size_t = 0 as libc::c_int as size_t;
    let mut authidlen: size_t = 0 as libc::c_int as size_t;
    let mut passwordlen: size_t = 0 as libc::c_int as size_t;
    ...
    *output_len =
        authzidlen.wrapping_add(1 as libc::c_int as
                                    libc::c_ulong).wrapping_add(authidlen).wrapping_add(1
                                                                                            ...
                                                                                            libc::c_int
                                                                                            as
                                                                                            libc::c_ulong).wrapping_add(passwordlen);

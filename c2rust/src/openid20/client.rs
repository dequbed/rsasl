...
#[no_mangle]
pub unsafe extern "C" fn _gsasl_openid20_client_start(mut sctx:
                                                          *mut Gsasl_session,
                                                      mut mech_data:
                                                          *mut *mut libc::c_void)
 -> libc::c_int {
    ...
    state =
        calloc(::std::mem::size_of::<openid20_client_state>() as
...
#[no_mangle]
pub unsafe extern "C" fn _gsasl_openid20_client_step(mut sctx:
                                                         *mut Gsasl_session,
                                                     mut mech_data:
                                                         *mut libc::c_void,
                                                     mut input:

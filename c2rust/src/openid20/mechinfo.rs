...
extern "C" {
    ...
    fn _gsasl_openid20_client_start(sctx: *mut Gsasl_session,
     ...
     -> libc::c_int;
    #[no_mangle]
    fn _gsasl_openid20_server_finish(sctx: *mut Gsasl_session,
                                     mech_data: *mut libc::c_void);
    #[no_mangle]
    fn _gsasl_openid20_server_step(sctx: *mut Gsasl_session,
                                   mech_data: *mut libc::c_void,
    ...
    #[no_mangle]
    fn _gsasl_openid20_server_start(sctx: *mut Gsasl_session,
                                    mech_data: *mut *mut libc::c_void)
     -> libc::c_int;
    #[no_mangle]
    fn _gsasl_openid20_client_finish(sctx: *mut Gsasl_session,
                                     mech_data: *mut libc::c_void);
    #[no_mangle]
    fn _gsasl_openid20_client_step(sctx: *mut Gsasl_session,
                                   mech_data: *mut libc::c_void,
                                   input: *const libc::c_char,
                                   input_len: size_t,
                                   output: *mut *mut libc::c_char,

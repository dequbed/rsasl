...
extern "C" {
   ...
   */
    ...
    #[no_mangle]
    fn _gsasl_securid_client_start(sctx: *mut Gsasl_session,
                                   mech_data: *mut *mut libc::c_void)
     -> libc::c_int;
    #[no_mangle]
    fn _gsasl_securid_client_step(sctx: *mut Gsasl_session,
    ...
    #[no_mangle]
    fn _gsasl_securid_client_finish(sctx: *mut Gsasl_session,
                                    mech_data: *mut libc::c_void);
    #[no_mangle]
    fn _gsasl_securid_server_step(sctx: *mut Gsasl_session,
                                  mech_data: *mut libc::c_void,
                                  input: *const libc::c_char,
                                  input_len: size_t,
                                  output: *mut *mut libc::c_char,
...
/* Get specification. */
#[no_mangle]
pub static mut gsasl_securid_mechanism: Gsasl_mechanism =
    unsafe {
        {
            let mut init =
                Gsasl_mechanism{name:
                                    b"SECURID\x00" as *const u8 as
                                        *const libc::c_char,
                                client:
                                    {
                                        let mut init =
                                            Gsasl_mechanism_functions{init:
                                                                          ...
                                                                          None,
                                                                      start:
                                                                          Some(_gsasl_securid_client_start
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      step:
                                                                          Some(_gsasl_securid_client_step
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                                                                       ...
                                                                                       ->
                                                                                           libc::c_int),
                                                                      finish:
                                                                          Some(_gsasl_securid_client_finish
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:
                                        ...
                                        let mut init =
                                            Gsasl_mechanism_functions{init:
                                                                      ...
                                                                      start:
                                                                          None,
                                                                      step:
                                                                          Some(_gsasl_securid_server_step
                                                                                   as
                                                                                   unsafe extern "C" fn(_:
                                                                                                            *mut Gsasl_session,
                                                                                                        _:

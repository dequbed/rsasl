...
pub unsafe extern "C" fn digest_md5_hmac(mut output: *mut libc::c_char,
                                         ...
                                         mut digesturi: *const libc::c_char,
                                         mut rspauth: libc::c_int,
                                         mut cipher: digest_md5_cipher,
                                         mut kic: *mut libc::c_char,
                                         mut kis: *mut libc::c_char,
                                         mut kcc: *mut libc::c_char,
                                         mut kcs: *mut libc::c_char)
 -> libc::c_int {
    let mut a2string: *const libc::c_char =
        if rspauth != 0 {
    ...
    p =
        p.offset(strlen(b":\x00" as *const u8 as *const libc::c_char) as
                     isize);
    memcpy(p as *mut libc::c_void, nonce as *const libc::c_void,
           strlen(nonce));
    ...
    if !authzid.is_null() && strlen(authzid) > 0 {
        ...
        p =
            p.offset(strlen(b":\x00" as *const u8 as *const libc::c_char) as
                         isize);
        memcpy(p as *mut libc::c_void, authzid as *const libc::c_void,
               strlen(authzid));
    ...
    if !kcc.is_null() {
        ...
        if cipher as libc::c_uint ==
               DIGEST_MD5_CIPHER_RC4_40 as libc::c_int as libc::c_uint {
            n = 5 as libc::c_int
        } else if cipher as libc::c_uint ==
                      DIGEST_MD5_CIPHER_RC4_56 as libc::c_int as libc::c_uint
         {
            n = 7 as libc::c_int
    ...
    p = tmp;
    if tmp.is_null() { return -(1 as libc::c_int) }
    memcpy(p as *mut libc::c_void, a2string as *const libc::c_void,
           strlen(a2string));
    p = p.offset(strlen(a2string) as isize);
    memcpy(p as *mut libc::c_void, digesturi as *const libc::c_void,
           strlen(digesturi));
    ...
    if qop as libc::c_uint &
        ...
        memcpy(p as *mut libc::c_void,
               ...
               strlen(b":00000000000000000000000000000000\x00" as *const u8 as
                          *const libc::c_char));
    }
    rc =
        gc_md5(tmp as *const libc::c_void, tmplen,
    ...
    p =
        p.offset(strlen(b":\x00" as *const u8 as *const libc::c_char) as
                     isize);
    memcpy(p as *mut libc::c_void, nchex.as_mut_ptr() as *const libc::c_void,
    ...
    if qop as libc::c_uint &
           DIGEST_MD5_QOP_AUTH_CONF as libc::c_int as libc::c_uint != 0 {
        memcpy(p as *mut libc::c_void,
               b"auth-conf\x00" as *const u8 as *const libc::c_char as
                   *const libc::c_void,
        ...
        p =
            p.offset(strlen(b"auth-int\x00" as *const u8 as
                                *const libc::c_char) as isize)
    } else if qop as libc::c_uint &
        ...
        p =
            p.offset(strlen(b"auth\x00" as *const u8 as *const libc::c_char)
                         as isize)
    }
    memcpy(p as *mut libc::c_void,
           b":\x00" as *const u8 as *const libc::c_char as
    ...
    *output.offset(32 as libc::c_int as isize) =

...
/* HAVE_LIBIDN */
#[no_mangle]
pub unsafe extern "C" fn gsasl_saslprep(mut in_0: *const libc::c_char,
                                        mut flags: Gsasl_saslprep_flags,
                                        mut out: *mut *mut libc::c_char,
                                        mut stringpreprc: *mut libc::c_int)
 -> libc::c_int {
    let mut i: size_t = 0;
    ...
    *out =
        malloc(inlen.wrapping_add(1 as libc::c_int as libc::c_ulong)) as
            *mut libc::c_char;

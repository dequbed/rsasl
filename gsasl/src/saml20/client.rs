...
use crate::consts::{GSASL_AUTHZID, GSASL_MALLOC_ERROR, GSASL_MECHANISM_CALLED_TOO_MANY_TIMES, GSASL_NEEDS_MORE, GSASL_NO_SAML20_IDP_IDENTIFIER, GSASL_OK, GSASL_SAML20_AUTHENTICATE_IN_BROWSER, GSASL_SAML20_IDP_IDENTIFIER, GSASL_SAML20_REDIRECT_URL};
use crate::gsasl::{Gsasl, Gsasl_session};
use crate::property::{gsasl_property_get, gsasl_property_set_raw};
...
#[no_mangle]
pub unsafe extern "C" fn _gsasl_saml20_client_step(mut sctx: *mut Gsasl_session,
